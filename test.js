...
//       newContact.pos = prompt("Nhập chức vụ: ");
//       MindX.push(newContact);
//       break;
...
//       if (action == "name") {
//         MindX[indexU].name = prompt("Sửa tên thành gì: ");
//       } else if (action == "age") {
//         MindX[indexU].age = parseInt(prompt("Sửa tuổi thành gì: "), 10);
//       } else if (action == "phonenumber") {
//         MindX[indexU].sdt = prompt("Sửa sđt thành gì: ");
//       } else if (action == "email") {
//         MindX[indexU].pos = prompt("Sửa chức vụ thành gì: ");
//       } else {
//         alert("Thoát sửa!");
//       }
//       break;
...
// if (checkDay(day) == true && checkMonth(month) == true) {
